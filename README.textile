...
h2. add data of suppliers and purchases, and a way to add and view them (can already be viewed in the inventory page)

h2. refresh my memory of the current system, to see what we're missing - and start filling in the gaps

h2. add some nice design

h2. play around with angular.js to improve UI
